...
public class AICarEngine2 : MonoBehaviour
{
    ...
    private void Start()
    {
        FL = GameObject.Find("wheelssss 1 col").GetComponent<WheelCollider>();
        FR = GameObject.Find("wheelssss col").GetComponent<WheelCollider>();
        Transform[] pathTransforms = path.GetComponentsInChildren<Transform>();
        nodes = new List<Transform>();
        RL = GameObject.Find("wheelssss 3 col").GetComponent<WheelCollider>();
        RR = GameObject.Find("wheelssss 2 col").GetComponent<WheelCollider>();
