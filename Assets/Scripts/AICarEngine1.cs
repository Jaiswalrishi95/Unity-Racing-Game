...
public class AICarEngine1 : MonoBehaviour
{
    ...
    private void Start()
    {
        FL = GameObject.Find("wheelsss 1 col").GetComponent<WheelCollider>();
        FR = GameObject.Find("wheelsss col").GetComponent<WheelCollider>();
        Transform[] pathTransforms = path.GetComponentsInChildren<Transform>();
        nodes = new List<Transform>();
        RL = GameObject.Find("wheelsss 3 col").GetComponent<WheelCollider>();
        RR = GameObject.Find("wheelsss 2 col").GetComponent<WheelCollider>();
